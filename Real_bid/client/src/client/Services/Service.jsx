  ...
  <div className='row firstele'>
    <div className='col-10 mx-auto'>
      ...
      <h1> <strong className='brand-name'>Our Team</strong></h1>
        <h2 className="my-3">
        Team RealBid, comes up with a idea to provide a platform for the sellers who want to sell thier product via bidding and want to get the best price. Our team verifies all the users. Team RealBid tries to make this platform 100% secure and safe. 
        </h2>
  ...
  <div className='row'>
    <div className='col-10 mx-auto'>
      ...
      <div className='col-md-6 pt-5 pt-lg-0 order-2 order-lg-2 d-flex justify-content-center flex-column' data-aos="fade-right" data-aos-delay="300">
        ...
        <h2 className="my-3">
        Auction in the physical mode is little difficult. Also, sellers can't put their product Globally for selling. So team RealBid has came with the vision to put your product globally for online bidding and get the best price
        </h2>
