				...
				<div className="col-md-12">
					<div className="wrapper">
						<div className="row mb-5" data-aos="fade-up" data-aos-delay="300">
			        		...
			        		<div className="text">
				            <p><span>Address:</span> Maitidevi</p>
				          </div>
			          </div>
							</div>
							<div className="col-md-3">
			        		...
			        		<div className="text">
				            <p><span>Phone:</span> <a href="tel://9869021446" >9869021446</a></p>
				          </div>
			          </div>
							</div>
							<div className="col-md-3">
			        		...
			        		<div className="text">
				            <p><span>Email:</span> <a href="mailto:adityacha26@gmail.com">Realbid@gmail.com</a></p>
				          </div>
			          </div>
							</div>
							<div className="col-md-3">
