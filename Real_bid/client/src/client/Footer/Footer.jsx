  ...
  <div className="container">
    <div className="row">
      ...
      <div className="col-lg-3 col-md-6 footer-contact">
        <h3>Realbid</h3>
        <p>
          Softwarica college<br/>
          maitidevi,Kathmandu<br/>
           <br/><br/>
          <strong>Phone:</strong>+977 9869021446<br/>
          <strong>Email:</strong> adityacha26@gmai.com<br/>
        </p>
      </div>
      ...
      <div className="col-lg-3 col-md-6 footer-links">
        ...
        <li><AiOutlineRight/> <NavLink to="/about" excat className="nav-link">About us</NavLink></li>
 ...
 */}
          ...
          <a href="https://x.com/Adityacha26" className="nav-link twitter"><FiTwitter/></a>
          <a href="https://www.linkedin.com/in/aditya-chaulagain-593718185/" className="nav-link twitter"><AiFillLinkedin/></a>
          <a href="https://www.instagram.com/adityachau30/" className="nav-link twitter"><FiInstagram/></a>
